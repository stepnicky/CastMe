          ...
          <div class="row border-bottom border-3 p-1 m-1">
            ...
            <div class="col d-flex justify-content-end mb-2 noPadding">
              <sec:authorize access="hasRole('CASTING_DIRECTOR')">
                <a href="/director/casting/add" class="btn btn-success">Add new casting</a>
              </sec:authorize>
            </div>
          </div>
                ...
                <c:forEach var="casting" items="${castings}">
                  <tr class="d-flex">
                    ...
                    <td class="col-2 d-flex align-items-center justify-content-center flex-wrap">
                      <sec:authorize access="hasRole('CASTING_DIRECTOR')">
                        <a href="/director/casting/${casting.id}/edit" class="btn btn-warning text-light m-1">
                          Edit
                        </a>
                        ...
                        <a href="/director/casting/${casting.id}/details" class="btn btn-info text-light m-1">
                          Details
                        </a>
                      </sec:authorize>
                      <sec:authorize access="hasRole('ACTOR')">
                        <a href="/actor/casting/${casting.id}/details" class="btn btn-info text-light m-1">
                          Details
                        </a>
                      </sec:authorize>
                    </td>
